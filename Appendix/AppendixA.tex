...
\label{appendix:gaussian-integral}

The multivariate Gaussian integral:
\begin{equation}
    \colorboxed{
        I = \int \prod_{n=1}^{N} \mathrm{d}x_n \, \exp\left(-\frac{1}{2} \bm{x}^\mathsf{T} A \bm{x} - \bm{x}^\mathsf{T} \bm{y}\right) = (2\pi)^{\frac{N}{2}} (\det A)^{-\frac{1}{2}} \exp\left(\frac{1}{2} \bm{y}^\mathsf{T} A^{-1} \bm{y}\right)
    }
\end{equation}
where:
\begin{itemize}
...
\begin{equation}
I_0 = \prod_{i=1}^{N} \sqrt{\frac{2\pi}{\lambda_i}} = (2\pi)^{\frac{N}{2}} \prod_{i=1}^{N} (\lambda_i)^{-\frac{1}{2}} = (2\pi)^{\frac{N}{2}} \left(\prod_{i=1}^{N} \lambda_i\right)^{-\frac{1}{2}}
\end{equation}
The determinant of a matrix is equal to the product of its eigenvalues. Thus, $\det A = \det D = \prod_{i=1}^{N} \lambda_i$.
\begin{equation}
I_0 = (2\pi)^{\frac{N}{2}} (\det A)^{-\frac{1}{2}}
\end{equation}
...
\begin{equation}
I = \exp\left(\frac{1}{2} \bm{y}^\mathsf{T} A^{-1} \bm{y}\right) \cdot I_0 = \exp\left(\frac{1}{2} \bm{y}^\mathsf{T} A^{-1} \bm{y}\right) (2\pi)^{\frac{N}{2}} (\det A)^{-\frac{1}{2}}
\end{equation}
Rearranging the terms yields the final result:
\begin{equation}
I = (2\pi)^{\frac{N}{2}} (\det A)^{-\frac{1}{2}} \exp\left(\frac{1}{2} \bm{y}^\mathsf{T} A^{-1} \bm{y}\right)
\end{equation}
