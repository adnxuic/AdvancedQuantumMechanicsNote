\section{Appendix B: Proof of the Multivariate Gaussian Integral}

\subsection{Statement of the Formula}
The formula to be proven is the multivariate Gaussian integral:
\begin{equation}
    \colorboxed{
...
\subsection{Step 1: Completing the Square}
...
\subsection{Step 2: Change of Variables (Translation)}
...
\subsection{Step 3: Diagonalization}
...
\subsection{Step 4: Computing the Decoupled Integral}
...
\subsection{Step 5: Combining the Results}
